...
- SC-006 performance verification path: `GHOSTFOLIO_CRYPTOGAINS_RUN_PERFORMANCE=1 go test ./tests/integration -run TestSyncPerformanceFlowLargeHistoryFixture -count=1 -v` was rerun on 2026-05-17 after the BUG-003 contract-alignment fix and completed in `248.161133ms` for `10000` activities across `6` available report years.
