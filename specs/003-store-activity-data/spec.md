...
- **FR-021**: The system MUST evaluate normalized histories for defensibility before persistence and MUST reject the sync when required reporting fields remain missing or contradictory after normalization or when replaying the normalized asset timeline would drive the running quantity for that asset below zero.
