...
- Coverage verification remains `make coverage`. Performance verification uses a deterministic 10,000-activity fixture spanning at least 5 years with worst-case supported lot fragmentation and is gated behind an opt-in environment variable.
