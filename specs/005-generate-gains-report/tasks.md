...
- [ ] T081 [P] Reconcile diagnostics artifact schema and manual inspection guidance for ordered `failure_cause_chain` entries in `specs/005-generate-gains-report/data-model.md`, `specs/005-generate-gains-report/quickstart.md`, and `specs/005-generate-gains-report/checklists/requirements.md`
