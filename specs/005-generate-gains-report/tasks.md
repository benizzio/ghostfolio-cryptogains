...
- [ ] T080 [P] [US2] Add nested-cause diagnostics security regression coverage proving secret-bearing wrapped causes are redacted or suppressed before they enter `failure_cause_chain` in `tests/integration/diagnostic_redaction_test.go` and `tests/integration/report_failure_flow_test.go`
