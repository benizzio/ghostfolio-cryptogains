...
- [ ] T106 Verify `CODE-STAND-DRIFT-005`, `CODE-STAND-DRIFT-006`, and `CODE-STAND-DRIFT-007` remediation with the maintained coverage command `make coverage` from the repository root and confirm the coverage artifacts remain under `dist/coverage/`; source: `coding-standards-drift-report.md#findings`
