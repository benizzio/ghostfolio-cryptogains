...
7. Active oracle materials do not include hledger command wrappers, generated journals, normalization paths, vendored source, executables, metadata, tests, or support labels; hledger references are permitted only in historical bug reports or explicit strikethrough rationale.
