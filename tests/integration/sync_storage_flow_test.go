...
func TestSyncStorageFlowCreatesProtectedSnapshotAfterSuccessfulMultiPageSync(t *testing.T) {
	...
	var server = newGhostfolioStorageServer(t, []storagePageFixture{
		{Count: 3, ActivitiesJSON: `[{"id":"activity-1","date":"2024-12-31T23:30:00-02:00","type":"BUY","quantity":1.25,"valueInBaseCurrency":62500,"feeInBaseCurrency":25,"unitPriceInAssetProfileCurrency":50000,"SymbolProfile":{"id":"asset-btc-storage-001","symbol":"BTC","name":"Bitcoin","currency":"USD"},"account":{"id":"account-1","name":"Main"}}]`},
		{Count: 3, ActivitiesJSON: `[{"id":"activity-2","date":"2025-01-01T00:15:00+02:00","type":"BUY","quantity":0.50,"valueInBaseCurrency":25000,"unitPriceInAssetProfileCurrency":50000,"SymbolProfile":{"id":"asset-btc-storage-001","symbol":"BTC","name":"Bitcoin","currency":"USD"}}]`},
		{Count: 3, ActivitiesJSON: `[{"id":"activity-3","date":"2026-05-01T09:00:00Z","type":"SELL","quantity":0.25,"valueInBaseCurrency":15000,"unitPriceInAssetProfileCurrency":60000,"SymbolProfile":{"id":"asset-btc-storage-001","symbol":"BTC","name":"Bitcoin","currency":"USD"}}]`},
	})
